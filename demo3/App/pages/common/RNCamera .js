      ...
      <View style={styles.container}>
        ...
        >
          <View
            style={{
              height:
                Platform.OS == 'ios' ? (height - 264) / 3 : (height - 244) / 3,
              width: width,
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <Image
              ...
              source={require('https://facebook.github.io/react-native/docs/assets/GettingStartedCongratulations.png')}
            >
              <Animated.View
                style={[
  ...
  renderNavBar() {
    return (
      <View style={styles.navBarStyle}>
        ...
        >
          <Image
            source={{ uri: 'nav_return' }}
            style={{ height: 20, width: 20 }}
          />
        </TouchableOpacity>
        <Text
          style={[
            styles.navTitleStyle,
            { marginTop: Platform.OS == 'ios' ? 12 : 0, fontSize: 20 }
          ]}
        >
          二维码
        </Text>
